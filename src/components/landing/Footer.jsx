...
const Footer = () => {
  ...
  return (
    <footer 
      className="text-slate-400 pt-20 pb-8 border-t border-slate-900 relative z-20 overflow-hidden bg-cover bg-center"
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10 grid grid-cols-1 md:grid-cols-12 gap-12 mb-16">
        {/* Column 1: Info & Stats */}
        <div className="md:col-span-6 flex flex-col items-start text-left gap-5">
      ...
      {/* Copy row */}
      <div className="max-w-7xl mx-auto px-6 relative z-10 pt-8 border-t border-slate-900 flex flex-col sm:flex-row gap-4 items-center justify-between text-left text-[11px] text-slate-600">
        <div>
